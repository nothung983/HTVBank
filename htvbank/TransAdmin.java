...
public class TransAdmin extends JFrame implements ActionListener {
    ...
    TransAdmin(int account_id) {
        ...
        JLabel title = new JLabel("Customers' Transfer History");
        ...
        findLabel.setForeground(new Color(0, 51, 153));
        add(findLabel);
    ...
    public void displayTransferHistory() {
        try {
            ...
            String query = "CALL GET_TRANS_ALL_USER;";
    ...
    public void searchTransaction(String filter, String value) {
        try {
            Connect c = new Connect();
            String query = "CALL GET_TRANS_ALL_USER(" + account_id2 + ");";
            ResultSet rs = c.s.executeQuery(query);
